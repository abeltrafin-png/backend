...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Data Tracer Alumni</h1>
        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Form Tambah Data Tracer Alumni</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('tracer-alumni.store') }}" method="POST">
                        ...
                        <div id="pekerjaan-fields" style="display: none;">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('bidang_pekerjaan') is-invalid @enderror" id="bidang_pekerjaan" name="bidang_pekerjaan" value="{{ old('bidang_pekerjaan') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('alamat_perusahaan') is-invalid @enderror" id="alamat_perusahaan" name="alamat_perusahaan" rows="2">{{ old('alamat_perusahaan') }}</textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('gaji_awal') is-invalid @enderror" id="gaji_awal" name="gaji_awal" value="{{ old('gaji_awal') }}" min="0">
                                        @error('gaji_awal')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('lama_mendapat_pekerjaan') is-invalid @enderror" id="lama_mendapat_pekerjaan" name="lama_mendapat_pekerjaan" value="{{ old('lama_mendapat_pekerjaan') }}" min="0">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('relevansi_pekerjaan') is-invalid @enderror" id="relevansi_pekerjaan" name="relevansi_pekerjaan">
                                            ...
                                            <option value="Sangat Relevan" {{ old('relevansi_pekerjaan') == 'Sangat Relevan' ? 'selected' : '' }}>Sangat Relevan</option>
                                            <option value="Relevan" {{ old('relevansi_pekerjaan') == 'Relevan' ? 'selected' : '' }}>Relevan</option>
                                            <option value="Kurang Relevan" {{ old('relevansi_pekerjaan') == 'Kurang Relevan' ? 'selected' : '' }}>Kurang Relevan</option>
                                            <option value="Tidak Relevan" {{ old('relevansi_pekerjaan') == 'Tidak Relevan' ? 'selected' : '' }}>Tidak Relevan</option>
                                        </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('kepuasan_pekerjaan') is-invalid @enderror" id="kepuasan_pekerjaan" name="kepuasan_pekerjaan">
                                    ...
                                    <option value="Sangat Puas" {{ old('kepuasan_pekerjaan') == 'Sangat Puas' ? 'selected' : '' }}>Sangat Puas</option>
                                    <option value="Puas" {{ old('kepuasan_pekerjaan') == 'Puas' ? 'selected' : '' }}>Puas</option>
                                    <option value="Cukup" {{ old('kepuasan_pekerjaan') == 'Cukup' ? 'selected' : '' }}>Cukup</option>
                                    <option value="Kurang" {{ old('kepuasan_pekerjaan') == 'Kurang' ? 'selected' : '' }}>Kurang</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('saran_untuk_kampus') is-invalid @enderror" id="saran_untuk_kampus" name="saran_untuk_kampus" rows="3">{{ old('saran_untuk_kampus') }}</textarea>
